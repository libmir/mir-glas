...
make -j
ar cr libblas_mix.a \
	isamax.o sasum.o sdot.o snrm2.o srot.o srotg.o sdsdot.o srotmg.o srotm.o sgemv.o sgbmv.o \
	ssymv.o ssbmv.o sspmv.o strmv.o stbmv.o stpmv.o strsv.o stbsv.o stpsv.o sger.o ssyr.o sspr.o ssyr2.o sspr2.o ssyrk.o \
	ssyr2k.o strmm.o strsm.o  idamax.o dasum.o ddot.o dnrm2.o drot.o drotg.o dsdot.o drotmg.o \
	drotm.o dgemv.o dgbmv.o dsymv.o dsbmv.o dspmv.o dtrmv.o dtbmv.o dtpmv.o dtrsv.o dtbsv.o dtpsv.o dger.o dsyr.o dspr.o \
	dsyr2.o dspr2.o dsyrk.o dsyr2k.o dtrmm.o dtrsm.o scabs1.o scasum.o scnrm2.o icamax.o cdotc.o cdotu.o \
	crotg.o csrot.o cgemv.o cgbmv.o chemv.o chbmv.o chpmv.o ctrmv.o ctbmv.o ctpmv.o ctrsv.o ctbsv.o \
	...
	dznrm2.o izamax.o zdotc.o zdotu.o zrotg.o zdrot.o zgemv.o zgbmv.o zhemv.o zhbmv.o \
